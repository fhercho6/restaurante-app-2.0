      ...
      >
        ...
        {isZReport ? (
            <div className="text-xs">
                ...
                {/* 2. VENTAS DIGITALES (ESTO FALTABA EN TU FOTO) */}
                <div className="mb-3 pb-3 border-b border-dashed border-gray-300">
                    <p className="font-bold mb-2 uppercase border-b border-gray-100 pb-1">Ventas Digitales</p>
                    <div className="flex justify-between mb-1">
                        <span>Ventas QR:</span>
                        <span className="font-bold">Bs. {data.stats.qrSales.toFixed(2)}</span>
                    </div>
                    <div className="flex justify-between mb-1">
                        <span>Ventas Tarjeta:</span>
                        <span className="font-bold">Bs. {data.stats.cardSales.toFixed(2)}</span>
                    </div>
                </div>

                {/* 3. TOTAL GLOBAL */}
                <div className="mb-3 pb-2 border-b border-dashed border-gray-300 bg-gray-100 p-2 rounded">
