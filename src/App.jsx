// src/App.jsx - CON REPORTE DE COSTOS Y GANANCIA EN CIERRE
...
export default function App() {
  ...
  // ESTADÍSTICAS DEL TURNO (Ahora incluye costo total de mercadería)
  const [sessionStats, setSessionStats] = useState({ 
      ...
      digitalSales: 0, 
      totalExpenses: 0, 
      totalCostOfGoods: 0, // <--- NUEVO: Costo de lo vendido
      expensesList: [],
      soldProducts: [] 
  });
  ...
  useEffect(() => { 
      ...
      const unsubSales = onSnapshot(qSales, (snap) => { 
          ...
          let totalCostCalc = 0; // Costo acumulado de toda la mercadería vendida
          const productMap = {}; 
          ...
          snap.forEach(doc => { 
              ...
              if (sale.items && Array.isArray(sale.items)) {
                  sale.items.forEach(item => {
                      ...
                      const price = parseFloat(item.price) || 0;
                      const cost = parseFloat(item.cost) || 0; // OBTENEMOS EL COSTO UNITARIO DEL ITEM
                      ...
                      productMap[key].totalCost += (cost * qty); // Acumulamos costo de este producto
                      
                      totalCostCalc += (cost * qty); // Acumulamos costo global
                  });
              }
          }); 
          ...
          setSessionStats(prev => ({ 
              ...
              totalCostOfGoods: totalCostCalc, // GUARDAMOS COSTO TOTAL
  ...
  const confirmCloseRegister = async (finalCash) => { 
      try { 
          ...
          const zReportData = { 
              ...
              finalCash: finalCash, 
              stats: sessionStats, // Incluye el totalCostOfGoods
              expensesList: sessionStats.expensesList,
              soldProducts: sessionStats.soldProducts 
          }; 
          
          setRegisterSession(null); 
          setSessionStats({ cashSales: 0, qrSales: 0, cardSales: 0, digitalSales: 0, totalExpenses: 0, totalCostOfGoods: 0, expensesList: [], soldProducts: [] }); 
